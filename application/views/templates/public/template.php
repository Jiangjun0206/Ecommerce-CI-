...
<script src="<?php echo base_url(); ?>assets/themes/admin/libs/jquery/dist/jquery-ui.js"></script>
<!-- JS Plugins -->
<script src="<?php echo base_url(); ?>assets/themes/default/js/plugins.js"></script>

<!-- JS Core -->
<?php
if(isset($admin_jsinc) && !empty($admin_jsinc)){
    for ($i = 0; $i < count($admin_jsinc); $i++) {
        ?>
        <script src="<?php echo base_url(); ?>assets/themes/admin/<?php echo $admin_jsinc[$i]?>"></script>
    <?php }
}
...
?>
<script src="<?php echo base_url(); ?>assets/themes/default/js/core.js"></script>

<?php echo $this->settings->get('analytics') ?>
</body>
</html>