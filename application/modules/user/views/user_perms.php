					...
					<span class="btn btn-sm btn-icon info">
                       ...
                       <!-- <ul class="nav navbar-nav pull-right m-l">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="nav-item">
                                <span class="navbar-item text-md"><?php echo $fname." ".$lname?> Permissions</span>
                            </li>
                                            ...
                                            <div class="row-col white bg">
                                                ...
                                                <div class="row-row">
                                                    <div class="row-body scrollable hover">
                                                        <div class="row-inner">
                                                            <!-- left content -->
                                                            <form action="<?php echo site_url('user/change_user_permissions') ?>" method="POST">
                                                                                ...
                                                                                <div class="form-group row">
                                                                                    <div class="col-sm-10">
                                                                                        ...
                                                                                        <label class="ui-switch data-ui-switch-md info m-t-xs">
                                                                                            <?php if ($controller->has_access($method->id,$user_id)){?>
