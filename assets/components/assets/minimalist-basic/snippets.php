...
<div data-num="122" data-thumb="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-cat="0">

</div>



<div data-num="2" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f3.png" data-cat="1">
    ...
    <div class="row clearfix">
        <div class="column half">
            <img src="<?=$url?>assets/minimalist-basic/products/1/product.jpg">
        ...
        <div class="column half">
            <div class="display" style="text-align:center;">
                ...
                <p>Just Pay <strong>$7.95</strong> To Cover Shipping & Handling.</p>
                
                    <a href="#" class="btn btn-primary edit btn-primary-sale big-button ship-button">Claim Your Free Watch Now<div class="btn-second-row">Limited Time Offer - Just Pay Shipping & Handling</div></a>
                
                <p><input id="upgrade_offer" name="upgrade_offer" type="checkbox"> Check this box if you would like to upgrade your<br/>order and get TWO Watches for just $13.95</p>
...
<div data-num="3" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f2.png" data-cat="1">


    <div class="row clearfix">
        <div class="column full center topbar topbar-s">
            <h1>Would you like to add this to your order?</h1>
        </div>
    </div>
        <br/><br/>
    ...
    <div class="row clearfix">
        <div class="column half">
            <img src="<?=$url?>assets/minimalist-basic/products/1/upsell.png">
        </div>
        <div class="column half">
            <div class="display" style="text-align:center;">
                <h1  style="font-family:Arial, sans-serif;font-size:32px;font-weight: 700;">SPECIAL OFFER.<br/>Bamboo Sunglasses</h1>
                <p  style="font-size:23px;">Complete your look with these amazing bamboo shades</p>
                
                    <a href="#" class="btn btn-primary edit btn-primary-sale big-button ship-button">Please upgrade my order for just $19.99<div class="btn-second-row">Just $19,99 (Usually $39,99)</div></a>
                
                <p><a style="color:blue;" class="no-thanks" href="#">No thanks, I will pass on the upgrade knowing that this is a one time offer.  Please let me complete my order, by clicking here.</a></p>
...
<div data-num="4" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f4.png" data-cat="1">
    ...
    <div class="row clearfix">
        ...
        <div class="column half">
            <div class="display" style="text-align:center;">
                ...
                <p  style="font-size:24px;">Your order was completed successfully</p>
                <p  style="font-size:26px;"><img width="120" src="<?=$url?>assets/minimalist-basic/express-mail-email-envelope-pictogram-vector-12188876.jpg" /></p>
    ...
    <div class="row clearfix">
        <div class="column full center topbar" style="background:#000000;color:white;margin-left:-50%;width:200%;font-size:18px;text-transform: uppercase;font-weight:700;text-align:center;padding:15px 0;">
            <h1  style="font-family:Arial, sans-serif;font-size:32px;font-weight: 700;">THANKS FOR SHOPPING WITH US TODAY</h1>
        </div>
    </div>
    <div class="row clearfix">
        <div class="column full center" style="margin-top:40px;">
            <a style="font-family:Arial, sans-serif;font-size:14px;color:#000;font-weight:700;" href="#"><span style="display:inline-block;width:150px;">Refund Policy</span><span style="display:inline-block;width:150px;">Terms of Service</span><span style="display:inline-block;width:150px;">Privacy Policy</span></a>
        </div>
    </div>
...
<div data-num="8" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f3.png" data-cat="2">

    <div class="row clearfix">
        <div class="column full center topbar topbar-s">
            <h1>KEEP YOUR BEARD LOOKING TRIM</h1>
        </div>
    </div>
    <div class="row clearfix">
        <div class="column half">
            <img src="<?=$url?>assets/minimalist-basic/products/2/product.jpg">
            <div class="clearfix is-rounded-button-medium share-container">
                <p><strong>Share With Your Friends!</strong></p>
                <div class="share-facebook"><i class="icon ion-social-facebook"></i></div>
                <div class="share-twitter"><i class="icon ion-social-twitter"></i></div>
        ...
        <div class="column half">
            <div class="display" style="text-align:center;margin-top:25px;">
                ...
                <p>Just Pay <strong>$7.95</strong> To Cover Shipping & Handling.</p>
                    ...
                    <a href="#" class="btn btn-primary edit btn-primary-sale big-button ship-button">Claim Your Free Beard Comb Now<div class="btn-second-row">Limited Time Offer - Just Pay Shipping & Handling</div></a>
                
                <p><input id="upgrade_offer" name="upgrade_offer" type="checkbox"> Check this box if you would like TWO combs for $13.95</p>
                <p>Grab Yours Before The <strong>Timer Ends!</strong></p>
...
<div data-num="7" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f2.png" data-cat="2">
    ...
    <div class="row clearfix">
        <div class="column half">
            <img src="<?=$url?>assets/minimalist-basic/products/2/upsell.png">
        </div>
        <div class="column half">
            <div class="display" style="text-align:center;">
                <h1  style="font-family:Arial, sans-serif;font-size:32px;font-weight: 700;">Beard oil</h1>
                <p  style="font-size:23px;">Keep you beard in tip top condition with this amazing natural oil </p>
                
                    <a href="#" class="btn btn-primary edit btn-primary-sale big-button upgrade-order">Please Upgrade My Order Now<div class="btn-second-row">Just $19,99 (Usually $39,99)</div></a>
...
<div data-num="9" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f4.png" data-cat="2">
...
<div data-num="12" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f3.png" data-cat="3">

    <div class="row clearfix">
        <div class="column full center topbar topbar-s">
            <h1>BRIGHTEN UP YOUR SMILES</h1>
        </div>
    </div>
    <div class="row clearfix">
        <div class="column half">
            <img src="<?=$url?>assets/minimalist-basic/products/3/product.jpg">
            <div class="clearfix is-rounded-button-medium share-container">
                <p><strong>Share With Your Friends!</strong></p>
                <div class="share-facebook"><i class="icon ion-social-facebook"></i></div>
                <div class="share-twitter"><i class="icon ion-social-twitter"></i></div>
        ...
        <div class="column half">
            <div class="display" style="text-align:center;">
                ...
                <p>Just Pay <strong>$7.95</strong> To Cover Shipping & Handling.</p>
                    ...
                    <a href="#" class="btn btn-primary edit btn-primary-sale big-button ship-button">Claim Your Free Teeth Set Now<div class="btn-second-row">Limited Time Offer - Just Pay Shipping & Handling</div></a>
                
                <p><input id="upgrade_offer" name="upgrade_offer" type="checkbox"> Check this box if you would like TWO packets for $13.95</p>
                <p>Grab Yours Before The <strong>Timer Ends!</strong></p>
...
<div data-num="11" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f2.png" data-cat="3">
    ...
    <div class="row clearfix">
        <div class="column half">
            <img src="<?=$url?>assets/minimalist-basic/products/3/upsell.png">
        </div>
        <div class="column half">
            <div class="display" style="text-align:center;">
                <h1  style="font-family:Arial, sans-serif;font-size:32px;font-weight: 700;">Black face mask</h1>
                <p  style="font-size:23px;">Clean out the pores in your face so your look as fresh as you teeth look bright.</p>
...
<div data-num="13" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f4.png" data-cat="3">
...
<div data-num="16" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f3.png" data-cat="4">

    <div class="row clearfix">
        <div class="column full center topbar topbar-s">
            <h1>ESSENTIAL FOR ALL ANIMAL FANS</h1>
        </div>
    </div>
    <div class="row clearfix">
        <div class="column half">
            <img src="<?=$url?>assets/minimalist-basic/products/4/product.jpg">
            <div class="clearfix is-rounded-button-medium share-container">
                <p><strong>Share With Your Friends!</strong></p>
                <div class="share-facebook"><i class="icon ion-social-facebook"></i></div>
                <div class="share-twitter"><i class="icon ion-social-twitter"></i></div>
        ...
        <div class="column half">
            <div class="display" style="text-align:center;">
                ...
                <p>Just Pay <strong>$7.95</strong> To Cover Shipping & Handling.</p>
                    ...
                    <a href="#" class="btn btn-primary edit btn-primary-sale big-button ship-button">Claim Your Free Necklace Now<div class="btn-second-row">Limited Time Offer - Just Pay Shipping & Handling</div></a>
                
                <p><input id="upgrade_offer" name="upgrade_offer" type="checkbox"> Check this box if you would like TWO Necklace for just $13.95</p>
                <p>Grab Yours Before The <strong>Timer Ends!</strong></p>
...
<div data-num="15" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f2.png" data-cat="4">
    ...
    <div class="row clearfix">
        <div class="column half">
            <img src="<?=$url?>assets/minimalist-basic/products/4/upsell.jpg">
        </div>
        <div class="column half">
            <div class="display" style="text-align:center;">
                <h1  style="font-family:Arial, sans-serif;font-size:32px;font-weight: 700;">Matching earrings</h1>
                <p  style="font-size:23px;">Get the earring that match the necklace and look totally awesome. </p>
...
<div data-num="17" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f4.png" data-cat="4">
...
<div data-num="20" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f3.png" data-cat="5">

    <div class="row clearfix">
        <div class="column full center topbar topbar-s">
            <h1>KEEP YOUR DOG HYDRATED</h1>
        </div>
    </div>
    <div class="row clearfix">
        <div class="column half">
            <img src="<?=$url?>assets/minimalist-basic/products/5/product.jpg">
            <div class="clearfix is-rounded-button-medium share-container">
                <p><strong>Share With Your Friends!</strong></p>
                <div class="share-facebook"><i class="icon ion-social-facebook"></i></div>
                <div class="share-twitter"><i class="icon ion-social-twitter"></i></div>
        ...
        <div class="column half">
            <div class="display" style="text-align:center;">
                ...
                <p>Just Pay <strong>$7.95</strong> To Cover Shipping & Handling.</p>
                    ...
                    <a href="#" class="btn btn-primary edit btn-primary-sale big-button ship-button">Claim Your Free Water Bottle Now<div class="btn-second-row">Limited Time Offer - Just Pay Shipping & Handling</div></a>
                
                <p><input id="upgrade_offer" name="upgrade_offer" type="checkbox"> Check this box if you would like TWO bottles for just $13.95</p>
                <p>Grab Yours Before The <strong>Timer Ends!</strong></p>
...
<div data-num="19" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f2.png" data-cat="5">
    ...
    <div class="row clearfix">
        <div class="column half">
            <img src="<?=$url?>assets/minimalist-basic/products/5/upsell.jpg">
        </div>
        <div class="column half">
            <div class="display" style="text-align:center;">
                <h1  style="font-family:Arial, sans-serif;font-size:32px;font-weight: 700;">Grooming glove</h1>
                <p  style="font-size:23px;">Groom and massage your dog at the same time with this cool grooming glove.</p>
...
<div data-num="21" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f4.png" data-cat="5">
    ...
    <div class="row clearfix">
        ...
        <div class="column half">
            <div class="display" style="text-align:center;">
                <h1 style="font-size:50px;font-weight: 700;">THANK YOU</h1>
                <p style="font-size:24px;">Your order was completed successfully</p>
                <p style="font-size:26px;"><img width="120" src="<?=$url?>assets/minimalist-basic/express-mail-email-envelope-pictogram-vector-12188876.jpg" /></p>
                <p>Confirmation of the order has been sent to your email address, check this for further details and information. <br/>Any questions contact support@yoursite.com</p>
            </div>
...
<div data-num="5" data-thumb="<?=$url?>assets/minimalist-basic/thumbnails/funnels/f5.png" data-cat="1,2,3,4,5">
