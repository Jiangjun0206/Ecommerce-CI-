...
var MODULE_CONFIG = {
    ...
    parsley:        [
                        admin_asset_url + 'libs/parsleyjs/dist/parsley.css',
                        admin_asset_url + 'libs/parsleyjs/dist/parsley.min.js'
                    ],
   /* select2:        [
    ...
    /*bootstrapWizard:[
                      admin_asset_url + 'libs/twitter-bootstrap-wizard/jquery.bootstrap.wizard.min.js'
                    ],*/
    fullCalendar:   [
                      'libs/moment/moment.js',
