(function ($) {
    ...
    $(document).on('click', '#funnel .item-title', function() {
        var value = this.id;
        
        var user_id = $('#funnel_user_id').val();
        var type = 0;
        window.location.href = '/page/page/funnel_page/' + value + '/' + type;
    });
    $(document).on('click', '#funnel_ready .item-title', function() {
        var value = this.id;
    ...
    $(document).on('click', '#funnel_club .item-title', function() {
        var value = this.id;
    ...
    $(document).on('click', '#page .item-title', function() {
        ...
        var funnel_id = $('#funnel_id').val();
        $("#detail").load(gurl + 'page/page_details/' + value + '/' + user_id + '/' + funnel_id);
        $('#detail').block({
            message: '<i class="fa fa-lg fa-refresh fa-spin"></i>' ,
            css: {
                border: 'none',
