...
button:{className:"btn btn-secondary"},collection:{tag:"div",className:"dt-button-collection dropdown-home",button:{tag:"a",className:"dt-button dropdown-item"}}}});a.ext.buttons.collection.className+=" dropdown-toggle";return a.Buttons});
