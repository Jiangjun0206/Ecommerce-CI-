...
var Dropdown = (function ($) {
  ...
  var Selector = {
    ...
    VISIBLE_ITEMS: '[role="home"] li:not(.disabled) a, ' + '[role="listbox"] li:not(.disabled) a'
  };
...
var Tab = (function ($) {
  ...
  var Selector = {
    ...
    LI: 'li',
    DROPDOWN: '.dropdown',
    UL: 'ul:not(.dropdown-home)',
    FADE_CHILD: '> .nav-item .fade, > .fade',
    ACTIVE: '.active',
    ACTIVE_CHILD: '> .nav-item > .active, > .active',
    DATA_TOGGLE: '[data-toggle="tab"], [data-toggle="pill"]',
    DROPDOWN_TOGGLE: '.dropdown-toggle',
    DROPDOWN_ACTIVE_CHILD: '> .dropdown-home .active'
  };
